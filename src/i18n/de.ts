...
export const de: Dict = {
  ...
  resources: {
    title: "Ressourcen",
    subtitle: "Quiz, Merkblätter und Kartenstapel, die der Tutor erstellt hat.",
    empty: "Noch nichts erstellt. Bitte den Tutor um ein Quiz oder ein Merkblatt.",
    open: "Öffnen",
    created: "Bereit",
    quiz: "Quiz",
    sheet: "Merkblatt",
    ...
    next: "Weiter",
    again: "Neu starten",
    score: "{{score}} von {{total}}",
    correct: "Richtig",
    wrong: "Nicht ganz",
    remove: "Löschen",
    otherDecks: "Stapel zu dieser Lektion",
    analysisDeck: "Aus der Analyse",
    regenerate: "Noch ein Quiz?",
  },
  collections: {
  ...
  doc: {
    ...
    quickActions: {
      ...
      prompts: {
        ...
        quiz: "Erstelle ein Quiz auf Niveau {{level}} mit {{count}} Fragen zu deiner letzten Antwort. Passe Komplexität und Erklärtiefe an dieses Niveau an. Stelle die Fragen einzeln und warte jedes Mal auf meine Antwort.",
      },
    },
    sections: {
      answer: "Antwort",
