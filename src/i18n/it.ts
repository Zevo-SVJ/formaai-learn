...
export const it: Dict = {
  ...
  doc: {
    ...
    deck: {
      ...
      hintSwipe: "Scorri per vedere la carta successiva",
      hintOpen: "Tocca una carta per leggerla tutta",
      hintSaveCard: "Tieni questa carta per dopo",
      hintSaveAnalysis: "Tieni tutta l'analisi",
